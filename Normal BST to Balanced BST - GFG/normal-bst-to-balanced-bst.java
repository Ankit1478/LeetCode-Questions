...
class GfG
{
    ...
    static Node sortedArrayToBST(List<Integer> ans, int start, int end){
         if (start > end)
            return null;
        ...
        newNode.left = sortedArrayToBST(ans,  start,mid-1);
        newNode.left = sortedArrayToBST(ans,  mid+1,end);
